"""Graph builder for Concept Pitch Agent."""
...
def build_concept_pitch_graph():
    """Build the Concept Pitch agent graph with streaming reply generation."""
    graph = StateGraph(ConceptPitchState)
