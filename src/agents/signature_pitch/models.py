...
class SignaturePitchState(MessagesState):
    ...
    current_section: SignaturePitchSectionID = SignaturePitchSectionID.CLARITY
    ...
    # Signature Pitch data - using CAPSTONE framework  
    canvas_data: dict[str, Any] = Field(default_factory=dict)  # Will store CAPSTONE data
    # Legacy data structure for backward compatibility  
    legacy_canvas_data: SignaturePitchData = Field(default_factory=SignaturePitchData)
