...
class SpecificWhoData(BaseModel):
    ...
    target_audience: str | None = Field(
        None, description="Detailed description of the target audience."
    )
    audience_characteristics: list[str] | None = Field(
        None, description="Key characteristics of the audience."
    )
