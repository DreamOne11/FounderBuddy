...
async def generate_decision_node(state: SignaturePitchState, config: RunnableConfig) -> SignaturePitchState:
    """
        ...
        if asking_for_feedback:
            ...
            if not agent_output.section_update:
                ...
                summary_patterns = [
                    ...
                    "change:", "who:", "outcome:", "credibility:", "story:", "signature:"
                ]
                            ...
                            "content": [
                                {
                                    ...
                                    "content": [
                                        {
                                            "type": "text",
                                            "text": last_ai_reply[:500] + "..." if len(last_ai_reply) > 500 else last_ai_reply
                                        }
                                    ]
                                }
                            ]
